...
export const tagSchema = {
    ...
    properties: {
        ...
        feature_image: {type: 'string', format: 'uri'},
        ...
        codeinjection_head: {type: 'string'},
        codeinjection_foot: {type: 'string'},
...
export const paramsData = {
    include: {
        description:
      'Tells the API to return additional data related to the resource you have requested. Doesn\'t work well with `fields`'
    },
    fields: {
    ...
    filter: {
        description:
      'Filter the result set to only include resources that match the provided criteria'
    },
    formats: {
    ...
    page: {
        description:
      'Paginate through collections of resources. By default, the first 15 records are returned.'
    },
    order: {
