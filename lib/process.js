...
import {generateNewSchema, writeJsonFile} from './preprocess.js';
import {writeSchema} from './traverse.js';
...
async function processPath({
    ...
    spec.paths[newPath][httpMethod].summary = description;
...
export async function processExtractedSchema({
    ...
    if (extractedSchema) {
      ...
      extractedSchema.properties[apiResource];
        ...
        await writeSchema(extractedResource, apiResource, api);
    }
